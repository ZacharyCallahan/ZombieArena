...
public final class ZombieArena extends JavaPlugin {
    ...
    public RegularMobArmorUpgradeGUI regularMobArmorUpgradeGUI;
    public UpgradeGUIHandler upgradeGUIHandler;
    public RegularMob regularMob;
    public RegularMobGUI regularMobGUI;
    ...
    public WaveAttackGUI waveAttackGUI;
    ...
    public ZombieArena() {
        ...
        this.regularMobArmorUpgradeGUI = new RegularMobArmorUpgradeGUI();
        ...
        this.upgradeGUIHandler = new UpgradeGUIHandler();
        this.regularMob = new RegularMob();
        this.regularMobGUI = new RegularMobGUI();
        ...
        this.waveAttackGUI = new WaveAttackGUI();
