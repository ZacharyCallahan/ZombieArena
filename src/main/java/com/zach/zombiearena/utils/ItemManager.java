...
public class ItemManager {
    ...
    public ItemManager() {
        moneyItem = ItemBuilder.createItem(ZombieArena.getInstance().getConfig().getString("tradergui.money-item.material"),
                ZombieArena.color(ZombieArena.getInstance().getConfig().getString("tradergui.money-item.display-name")), null,

                ZombieArena.getInstance().getConfig().getStringList("tradergui.money-item.lore"), null,

                ZombieArena.getInstance().getConfig().getBoolean("tradergui.money-item.enchanted"));
        starterBow = ItemBuilder.createItem(ZombieArena.getInstance().getConfig().getString("starter-item.material"),
                ZombieArena.getInstance().getConfig().getString("starter-item.display-name"), null,

                ZombieArena.getInstance().getConfig().getStringList("starter-item.lore"),
                ZombieArena.getInstance().getConfig().getStringList("starter-item.enchants"), false);
        upgradePurchased = ItemBuilder.createItem((ZombieArena.getInstance()).config.getPurchasedUpgradeItemMaterial(),
                ...
                (ZombieArena.getInstance()).config.getPurchasedUpgradeItemLore(), null, null,
        ...
        upgradeUnavailable = ItemBuilder.createItem((ZombieArena.getInstance()).config.getUpgradeUnavailableItemMaterial(),
                ...
                (ZombieArena.getInstance()).config.getUpgradeUnavailableItemLore(), null, null,
